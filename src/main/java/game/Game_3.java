...
public class Game_3 extends JFrame implements KeyListener, ActionListener {
    ...
    @Override//empezar el juego presionando el espacio
     ...
     * @param ae 
     */    //añade random los diferente bichos
    @Override
    ...
    private void loadNewBoard(int counter){
        switch(counter){
            default:
              ...
              gObjs.add(new Bee(new Position(8,8), 10, 10, gObjs));
              gObjs.add(new Spider(new Position(8,2), 4, 1, ridingHood));
              gObjs.add(new Bee(new Position(11,1), 4, 10, gObjs));
              gObjs.add(new Spider(new Position(1,11), 4, 10, ridingHood));
              break;
            /*case 1:
