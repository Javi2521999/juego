...
public abstract class AbstractGameObject implements IGameObject, IToJsonObject{
    protected BehaviourFactory behaviourFactory = new BehaviourFactory();
    public ConcurrentLinkedQueue<IGameObject> gObjs = new ConcurrentLinkedQueue<>();
    ...
    public IBehaviour getBehaviour() {
        return this.behaviourFactory.getBehaviour(this.mode);
    }
}